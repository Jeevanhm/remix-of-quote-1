    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6 grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-6">
        ...
        <main className="space-y-6">
          ...
          {/* Disclaimer */}
          <div className="mt-6 rounded-md border border-amber-400/50 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-700/50 px-4 py-2.5 flex items-center gap-2.5">
